class AutosController < ApplicationController
  ...
  private
    ...
    def auto_params
      params.require(:auto).permit(:make, :model, :year, :trim, :vin, :auto_img, :auto_description, :condition, :mileage, :list_price, :price_sold, :sold, :featured, :purchase_price, :purchase_date, :price_sold, :date_sold, :sold_by, :user_id)
    end
end
